...
def bingtrans(usersay, sayto = 'en'):
    ...
    #base_url = 'http://api.microsofttranslator.com/V2/Http.svc/Translate?from=%s&to=%s&appId=%s&text=' %(sayfrom,sayto,bingkey)
    base_url = 'http://api.microsofttranslator.com/V2/Http.svc/Translate?to=en&appId=%s&text=' %(bingkey)
    ...
    bingtrans = urllib2.urlopen(url).read()#.decode("utf-8")
    bingtrans = urllib2.unquote(strip_tags(bingtrans))#.decode("gbk").encode("utf-8")
